//! How this destination rolls its output into part files: the
//! vocabulary the Snowflake destination's own config document speaks.
//!
//! Owned here rather than shared, because it IS this connector's
//! vocabulary — a part here is a file staged for `PUT`, and what
//! should end one is a question about this connector's staging, not
//! about parquet on a filesystem. A neighbouring connector answering
//! the same question is answering it about its own writer.
//!
